...
| 15. City relationship | [relationship_city.py, relationship_state.py, 100-relationship_states_cities.py](./relationship_city.py, relationship_state.py, 100-relationship_states_cities.py) |
